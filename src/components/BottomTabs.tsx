...
export default function BottomTabs() {
    ...
    return (
        <div className='fixed bottom-0 w-full lg:w-1/4 lg:max-w-sm md:max-w-full sm:max-w-full max-w-full h-[50px] bg-white border-t border-t-gray-300 flex justify-center gap-2 items-center px-2 z-20'>
